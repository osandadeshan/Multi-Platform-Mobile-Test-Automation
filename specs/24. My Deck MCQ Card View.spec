My Deck MCQ Card View Specification
===================================
...
tags: my_deck_mcq_card_view



Verify that a user can navigate to MCQ card view by tapping on card preview text on the card list
-------------------------------------------------------------------------------------------------
* Navigate to "Accounting: A Faster Way" My Deck Card list page
* Verify that the My Deck title is "Accounting: A Faster Way"
* Verify that the My Deck card titles are visible
...
Verify that a user can navigate to my deck cards list page by tapping on X button
---------------------------------------------------------------------------------
...
* Verify that the My Deck title showing here is "Accounting: A Faster Way"
